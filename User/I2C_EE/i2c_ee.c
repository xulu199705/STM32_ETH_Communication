...
TestStatus ARMJISHU_EEPROM_TEST(void)
{
  TestStatus EepromTestStatus = FAILED;

  u8 EEP_Tx_Buffer[] = "WWW.ARMJISHU.COM  I2C EEPROM AT24C02 Test";
  #define  EEPTx_BUFSIZE    sizeof(EEP_Tx_Buffer) / sizeof(EEP_Tx_Buffer[0])
  #define  EEP_Firstpage      0x00
  #define  EEP_Randompage			0x06
  u8 EEP_Rx_Buffer[EEPTx_BUFSIZE] = {0};  
  
  I2C_EE_Init();

  //printf("\r\n\n ARMJISHU_EEPROM_TEST........");  
  ...
  EepromTestStatus = Buffercmp(EEP_Tx_Buffer, EEP_Rx_Buffer, EEPTx_BUFSIZE-1);
  ...
  // notice this  www.armjishu.com
  I2C_DeInit(I2C1);
  I2C_Cmd(I2C1, DISABLE);
  I2C_GPIO_DeConfig();

  return EepromTestStatus;
}
